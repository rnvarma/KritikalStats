...
URL = "https://www.tabroom.com/index/tourn/results/round_results.mhtml?tourn_id=2275&round_id=77291"
...
def get_info_from_text(text):
  ...
  for i in xrange(10, len(text), 10):
  	round_list = text[i - 10: i]
