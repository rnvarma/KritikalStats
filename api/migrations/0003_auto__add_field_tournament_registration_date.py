...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.registration_date'
        db.add_column(u'api_tournament', 'registration_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.registration_date'
        db.delete_column(u'api_tournament', 'registration_date')
